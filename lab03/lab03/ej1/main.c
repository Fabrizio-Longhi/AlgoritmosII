...
int main(void) {
    ...
    p=&x;     //guardo direccion de la variable x en p
    *p=9;     //uso * a la izq, para modificar el valor de la memoria de p

    q= &m;      //apunto a la tupla
    q->age=100;
    q->name_initial='F';
    
    p=NULL;
    p=a;   //guardo la direccion del arreglo a en p (a es un puntero, por eso no se usa &)
    p[1]=42;
