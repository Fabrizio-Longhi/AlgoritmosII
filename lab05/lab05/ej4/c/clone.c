...
//El error de la funcion string_clone es que deberia devolver un puntero a memoria dinamica,
//solo esta trabajando en el stack

//length tomo al principio de string_clone el valor 1453